%%Assignment 3: Part 3
%% Part 3: Question 2
%Firstly, the voltage map and electric field plots will be generated again. 
%This time, the voltage map will be coupled with the monte
...
% The particles will now move between the two boxes
    ...
    %at the edges of the two boxes. The particles that
